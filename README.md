USAGE - Run mangadex-dl and follow instructions.


# imageToPDF

A script to convert the output of mangadex-dl into a single PDF.

# mangadex-dl - ALMOST ENTIRELY NOT WRITTEN BY MYSELF. I DO NOT TAKE CREDIT FOR THE WEBSCRAPING PORTION OF THIS CODE (basically 95+%).
I MADE SMALL MODIFICATIONS FOR IT TO:
1. OPERATE WITH MY PDF SCRIPT
2. QUEUE MULTIPLE MANGA + SPECIFIED CHAPTERS AT A TIME FOR PDFFING
SEE https://github.com/frozenpandaman/mangadex-dl
